(ns financeiro.saldo-aceitacao-test
  (:require [midje.sweet :refer :all]
            ...
            [financeiro.auxiliares :refer [iniciar-servidor parar-servidor
                                           porta-padrao conteudo-como-json
                                           conteudo endereco-para
                                           receita despesa]]
            [financeiro.db :as db]
...
(against-background [(before :facts [(iniciar-servidor
                    ...
                    (fact "O saldo é 1000 quando criamos duas receitas de 2000 e uma despesa da 3000"
                          :aceitacao
